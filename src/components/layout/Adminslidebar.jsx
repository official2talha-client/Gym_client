...
const NAV_ITEMS = [
  ...
  },
  {
    to: "members",
    label: "Members",
    icon: <Icon.members width={18} height={18} />,
  },
  {
    to: "trainers",
    label: "Trainers",
    icon: <Icon.trainers width={18} height={18} />,
  },
  {
    to: "plans",
    label: "Plans",
    icon: <Icon.plans width={18} height={18} />,
  },
  {
    to: "purchase",
    label: "Purchases",
  ...
  },
  {
    ...
    icon: <Icon.video width={18} height={18} />,
  },
  {
    to: "reviews",
    label: "Reviews",
    icon: <Icon.reviews width={18} height={18} />,
  },
  {
    to: "gallery",
    label: "Gallery",
    icon: <Icon.gallery width={18} height={18} />,
  },
  {
    to: "faqs",
    label: "FAQs",
    icon: <Icon.faqs width={18} height={18} />,
  },
  {
    to: "settings",
    label: "Settings",
